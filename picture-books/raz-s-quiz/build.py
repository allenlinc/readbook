#!/usr/bin/env python3
# Build the RAZ-S quiz site from _quizdata/*.json
#   - raz-s-quiz/index.html        (hub: search + skill filter + grid)
#   - raz-s-quiz/books/<slug>.html  (one interactive page per book)
...
<title>RAZ-S 阅读理解 · Reading by Level</title>
...
<div class="wrap">
  ...
  <div class="hub-hero">
    <h1><span class="en">RAZ Level S · Reading Comprehension</span><span class="zh">RAZ Level S · 阅读理解练习</span></h1>
...
__CARDS__
  ...
  <footer><span class="en">RAZ-S Quick Check · questions written from the original books</span><span class="zh">RAZ-S 阅读理解 · 题目依据原书内容编写</span></footer>
</div>
<script>
var BOOKS = __BOOKS__;
...
<div class="wrap">
  ...
  <div id="app"></div>
  <footer><a href="../index.html"><span class="en">← Back to RAZ-S</span><span class="zh">← 返回 RAZ-S 书单</span></a></footer>
</div>
