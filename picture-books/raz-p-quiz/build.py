#!/usr/bin/env python3
# Build the RAZ-P (picture books) quiz site from _quizdata/*.json
#   - picture-books/raz-p-quiz/index.html      (hub: search + skill filter + grid)
#   - picture-books/raz-p-quiz/books/<slug>.html (one interactive page per book)
# Mirrors raz-o-quiz/build.py but for RAZ Level P picture books.
...
<title>RAZ-P 绘本 · Reading by Level</title>
...
<div class="wrap">
  ...
  <div class="hub-hero">
    <h1><span class="en">RAZ Level P · Picture Books</span><span class="zh">RAZ Level P · 绘本阅读理解</span></h1>
    <p><span class="en">__COUNT__ leveled picture books — 10 bilingual questions + 1 open-ended question each. Choose a book to start!</span><span class="zh">__COUNT__ 本分级绘本，每本 10 道中英双语阅读理解题 + 1 道思考题。选一本开始吧！</span></p>
  </div>
  <div class="controls">
...
__CARDS__
  ...
  <footer><span class="en">RAZ-P Picture Books · questions written from the original books</span><span class="zh">RAZ-P 绘本 · 题目依据原书内容编写</span></footer>
</div>
<script>
var BOOKS = __BOOKS__;
...
<div class="wrap">
  ...
  <div id="app"></div>
  <footer><a href="../../index.html"><span class="en">← Back to RAZ-P</span><span class="zh">← 返回 RAZ-P 书单</span></a></footer>
</div>
