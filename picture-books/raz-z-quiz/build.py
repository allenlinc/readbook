#!/usr/bin/env python3
# Build the RAZ-Z quiz site from _quizdata/*.json
...
<title>RAZ-Z 阅读理解 · Reading by Level</title>
...
__CARDS__
  ...
  <footer><span class="en">RAZ-Z Quick Check · questions written from the original books</span><span class="zh">RAZ-Z 阅读理解 · 题目依据原书内容编写</span></footer>
</div>
<script>
var BOOKS = __BOOKS__;
...
<div class="wrap">
  ...
  <div id="app"></div>
  <footer><a href="../index.html"><span class="en">← Back to RAZ-Z</span><span class="zh">← 返回 RAZ-Z 书单</span></a></footer>
</div>
