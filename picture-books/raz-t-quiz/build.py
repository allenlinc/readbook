#!/usr/bin/env python3
# Build the RAZ-T quiz site from _quizdata/*.json
...
<title>RAZ-T 阅读理解 · Reading by Level</title>
...
<div class="wrap">
  ...
  <div class="hub-hero">
    <h1><span class="en">RAZ Level T · Reading Comprehension</span><span class="zh">RAZ Level T · 阅读理解练习</span></h1>
...
__CARDS__
  ...
  <footer><span class="en">RAZ-T Quick Check · questions written from the original books</span><span class="zh">RAZ-T 阅读理解 · 题目依据原书内容编写</span></footer>
</div>
<script>
var BOOKS = __BOOKS__;
...
<div class="wrap">
  ...
  <div id="app"></div>
  <footer><a href="../index.html"><span class="en">← Back to RAZ-T</span><span class="zh">← 返回 RAZ-T 书单</span></a></footer>
</div>
