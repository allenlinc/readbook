...
# -*- coding: utf-8 -*-
"""
Build script for the Dragon Masters quiz site.

1. gen_quizzes()  -> reads _quizdata/<NN>.json and emits one self-contained
                     bilingual (EN/ZH) quiz HTML per book.
2. gen_hub()      -> rebuilds index.html listing ALL 28 books (1-28).
...
QUIZ_CSS = """  :root{
  ...
  *{box-sizing:border-box;}
  ...
  button.go:hover{transform:translateY(-2px);box-shadow:0 6px 18px rgba(108,92,231,.5);}
...
<div class="wrap">
  ...
  <footer>Based on <em>Dragon Masters: __TITLE__</em> (Scholastic Branches, __YEAR__) — by __AUTHOR__</footer>
</div>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Dragon Masters — Books</title>
<style>
  :root{{
    --grass:#27ae60;
    --grass-dark:#1e8449;
  ...
  *{{box-sizing:border-box;}}
  ...
  header{{
    background:var(--dragon);color:#fff;text-align:center;
...
<header>
  <div class="topbar">
    <a class="homeBtn" href="../../index.html" title="Home / 首页" aria-label="Home">🏠</a>
    <h1>Dragon Masters</h1>
    <span style="width:40px"></span>
  </div>
  <div class="dragon">🐉</div>
  <p>初章书 · Early Chapter Books — by {AUTHOR}</p>
</header>

<div class="wrap">
  <div class="intro">
    🐉 <b>{count} 本《驯龙大师》冒险故事（#{lo}–#{hi}），每本都有中英双语阅读理解测验。</b><br>
    {count} Dragon Masters adventures, each with a bilingual (English / 中文) comprehension quiz. Tap a book, read the questions, then check your answers!
  </div>
