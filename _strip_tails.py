...
roots = ["early-chapter", "middle-chapter", "higher-chapter"]
changed = 0
for root in roots:
    for jf in glob.glob(os.path.join(root, "*", "_quizdata", "*.json")) + glob.glob(os.path.join(root, "*", "_bookdata", "*.json")):
        ...
        if fc:
            ...
            changed += 1
print("files stripped of all tails:", changed)
