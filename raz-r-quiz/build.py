#!/usr/bin/env python3
# Build the RAZ-R quiz site from _quizdata/*.json
#   - raz-r-quiz/index.html        (hub: search + skill filter + grid)
#   - raz-r-quiz/books/<slug>.html  (one interactive page per book)
...
<title>RAZ-R 阅读理解 · Reading by Level</title>
...
<div class="wrap">
  ...
  <div class="hub-hero">
    <h1><span class="en">RAZ Level R · Reading Comprehension</span><span class="zh">RAZ Level R · 阅读理解练习</span></h1>
...
__CARDS__
  ...
  <footer><span class="en">RAZ-R Quick Check · questions written from the original books</span><span class="zh">RAZ-R 阅读理解 · 题目依据原书内容编写</span></footer>
</div>
<script>
var BOOKS = __BOOKS__;
...
<div class="wrap">
  ...
  <div id="app"></div>
  <footer><a href="../index.html"><span class="en">← Back to RAZ-R</span><span class="zh">← 返回 RAZ-R 书单</span></a></footer>
</div>
